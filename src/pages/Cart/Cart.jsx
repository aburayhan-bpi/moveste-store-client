    ...
    <div className="">
      <div className="w-full max-w-7xl mx-auto px-4 xl:px-0 mt-32 pb-20">
        ...
        <div className="lg:grid grid-cols-12 space-y-6 md:space-y-0 md:gap-10">
          ...
          <div className="col-span-8 border-gray-200">
            ...
            {Array(4)
              ...
              .map((_, i) => (
                ...
                >
                  <div className="col-span-12 md:col-span-6 flex w-full gap-3 mx-auto">
                    {/* Img */}
                    <div className="w-fit">
                      <img
                        className="w-32"
                    ...
                    <div className="w-fit text-gray-800 text-sm text-wrap h-fit">
                      <h2 className="text-xl mb-3 break-all">
                        T-shirt for men
                      </h2>
                      <p>Color: Blue</p>
                      <p>Size: XL</p>
          ...
          {/* Sidebar */}
          <div className="sticky top-20 items-center justify-center col-span-4 border-gray-200 p-2 mt-10 lg:mt-0">
